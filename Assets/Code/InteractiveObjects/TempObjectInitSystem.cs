...
namespace InteractiveObjects
{
    ...
    public class TempObjectInitSystem : IEcsInitSystem
    {
        ...
        {
            var handle =
                Addressables.InstantiateAsync("InteractiveObject", new Vector3(15, 1, 17), Quaternion.identity);
            ...
            var handle3 =
                Addressables.InstantiateAsync("InteractiveObject", new Vector3(13, 1, 15), Quaternion.identity);
